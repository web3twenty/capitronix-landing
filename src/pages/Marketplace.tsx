            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <Badge className={
                  ...
                  item.status === 'Upcoming' ? 'bg-amber-500/10 text-amber-400 font-bold' :
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <Button variant="ghost" onClick={onBack} className="mb-8 text-slate-400 hover:text-white group">
              ...
              >
                ...
                >
                  <div className="relative h-48 mb-6 rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                      <Badge className={
                        ...
                        project.status === 'Upcoming' ? 'bg-amber-500/20 text-amber-400 border-amber-500/30' :
                  ...
                  <div className="flex-grow">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-cyan-400 font-bold">{project.price}</div>
                      </div>
                    </div>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/5 flex gap-2">
                    <Button variant="ghost" className="flex-grow p-0 h-10 text-slate-400 hover:text-cyan-400 text-sm">View Archive</Button>
